...
namespace DotNetDocs.MemberDocumentations
{
    ...
    /// </summary>
    public class ReturnValueDocumentation : MethodInputOutputDocumentationBase
    {
        ...
        internal ReturnValueDocumentation(MethodReturnType methodReturnType, XElement xElement)
            : base(xElement)
        {
